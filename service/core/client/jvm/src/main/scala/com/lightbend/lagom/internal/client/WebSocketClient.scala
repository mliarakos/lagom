...
import io.netty.handler.codec.http.websocketx.{ WebSocketVersion => NettyWebSocketVersion, _ }
...
private[lagom] abstract class WebSocketClient(
  ...
  def connect(
    ...
    val nettyVersion = version match {
      case WebSocketVersion.V13 => NettyWebSocketVersion.V13
      case WebSocketVersion.V08 => NettyWebSocketVersion.V08
      case WebSocketVersion.V07 => NettyWebSocketVersion.V07
      case WebSocketVersion.V00 => NettyWebSocketVersion.V00
      case _                    => NettyWebSocketVersion.UNKNOWN
    }
